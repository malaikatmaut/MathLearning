...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->menu->addMenu('user_menu', ['menu' => $this->input->post('menu')]);
    ...
    {
        $this->menu->deleteMenu($this->input->get('id'));
    ...
    public function submenu()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->menu->addSubMenu('user_sub_menu', $data);
    ...
    {
        $this->menu->deleteSubmenu($this->input->get('id'));
